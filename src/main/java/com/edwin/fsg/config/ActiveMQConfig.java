...
public class ActiveMQConfig {
	 ...
	 * [点对点 模式]   
	 * @author: yulang
	 * @date:   2018年8月13日 下午5:30:40  
	 * @version V1.0
	 */
	@Bean
    public Queue queue() {
        return new ActiveMQQueue("edwin.queue");
    }

	/**
	 * [广播模式]   
	 * @author: yulang
	 * @date:   2018年8月13日 下午5:30:45  
	 * @version V1.0
	 */
    @Bean
    public Topic topic() {
        return new ActiveMQTopic("edwin.topic");
    }
    
    /**
     * [消息重发策略]   
     * @author: yulang
     * @date:   2018年8月14日 上午10:26:46  
     * @version V1.0
     */
	@Bean
	...
	/**
	 * [配置ActiveMQConnectionFactory工厂]   
	 * @author: yulang
	 * @date:   2018年8月13日 下午5:43:11  
	 * @version V1.0
	 */
    @Bean
    ...
    public JmsTemplate jmsTemplate(ActiveMQConnectionFactory activeMQConnectionFactory,Queue queue){
    	...
    	jmsTemplate.setPubSubDomain(true); //开启订阅模式
    	return jmsTemplate;
    }
